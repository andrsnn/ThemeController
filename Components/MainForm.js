            ...
            return [
            	"<div class='themeController jumbotron'>",
                        "<div class='modal-header'>",
                              ...
                              "<div type='button' style='float:left;' data-dismiss='modal' id='minimize' aria-hidden='true' class='close'>_</div>",
                        ...
                        "<div class='modal-footer' style='border-top-width: 0px;'>",
                              ...
                              "<div style='float:left;' id='inspect' class='btn'>Inspect</div>",
